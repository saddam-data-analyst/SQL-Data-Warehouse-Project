...
Script Purpose:
    ...
    --Referential integrity between fact  and dimesion tables
    --Validation of relationships in the data model for analytical purpose.

Usage Notes
  --Run this checks after data loading Silver Layer.
 --Investigating and resolve any discrepencies found during the checks.
*/
...
--===================================================================
--Check for unique of Product key in gold.dim_products
--Expectation : No Results
SELECT
    product_key,
    COUNT(*) AS duplicate_count
